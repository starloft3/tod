...
def SaveGame():
    ...
    for x in allunits:
        templist = tuple(x)
        unitdata_cur.execute("INSERT INTO saveunits VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", templist)
    unitdata_cur.close()
