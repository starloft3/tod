...
def redraw():
    ...
    if GIVE_BASE_TOGGLE == 1:
        ...
        CONFIRM_CARAVAN_ONE_TEXT = menuFont.render('Confirm caravan to ' + getCaravanData()[0] + '?', True, GOLD)#JIMGO
...
class mapUnit:
    def __init__(self, hexnumber, overallfaction, capacity, domain, category, movesleft, movesmax, vision, combat, HP, maxHP, faction, unitType, area, selected, movesMade, destination, orders, alive, transportOne, transportTwo, isLeader, xshift, yshift):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:
                ...
                #confirm unit
                    ...
                    if CONFIRM_CARAVAN_YES_TEXTrect.collidepoint(pygame.mouse.get_pos()) == 1:#GOHERE
