...
def loadgame():
    ...
    #inputbox.display_box(windowSurface, "WHAT'S UP")
...
def drawBaseFactionHexes(hex, faction):
    ...
    windowSurface.lock()
    pygame.draw.rect(windowSurface, BLACK, (x, y, 6, 6))
    windowSurface.unlock()
...
def drawUnitFactionHexes(hex, faction):
    ...
    windowSurface.lock()
    pygame.draw.rect(windowSurface, BLACK, (x, y, 4, 4))
    windowSurface.unlock()
...
def redraw():
    ...
    if checkBaseSelected() != -1:
        ...
        BASE_PORTRAIT_RECT = (pygame.Rect(int(1035 * resX), int(410 * resY), int(200 * resX), int(200 * resY)))
...
inputbox.display_loading_status(windowSurface, 'Loading units...', -200)
loadsavedunits()
inputbox.display_loading_status(windowSurface, 'Loading map...', -175)
loadsavedmap()
inputbox.display_loading_status(windowSurface, 'Loading roads...', -150)
loadroads()
inputbox.display_loading_status(windowSurface, 'Loading bases...', -125)
loadsavedbases()
inputbox.display_loading_status(windowSurface, 'Loading buildables...', -100)
loadbuildables()
