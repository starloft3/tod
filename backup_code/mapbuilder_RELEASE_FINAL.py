...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 3:
                if checkSelected() != -1 and units[checkSelected()].faction == currentfaction and (units[checkSelected()].orders == 'None' or 'Move' in units[checkSelected()].orders):
