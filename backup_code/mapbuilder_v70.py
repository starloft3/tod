...
#function to generate starting map coordinates based on faction #GOTO
def setMap():
    if currentfaction == 0:
        return (-3400, -1400)
    if currentfaction == 1:
...
class mapUnit:
    def __init__(self, hexnumber, overallfaction, capacity, domain, category, movesleft, movesmax, vision, combat, HP, maxHP, faction, unitType, area, selected, movesMade, destination, orders, alive):
