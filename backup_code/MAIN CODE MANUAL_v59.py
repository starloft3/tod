...
def resolveExpansions():
    ...
    for x in range(len(toberesolved)):
        ...
        if allhexes[toberesolved[x][pick][1]][HEX_TERRAIN]=='O' and int(allhexes[toberesolved[x][pick][1]][HEX_OIL])==1:
            allhexes[toberesolved[x][pick][1]][HEX_RIG]=toberesolved[x][pick][0]
